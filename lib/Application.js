...
let NYTimesRecommendations = {
  ...
  getInterests: function NYTR_getInterests() {
    let interests = {};
  ...
  pagemod: {
    ...
    onAttach: function(worker) {
      ...
      NYTimesRecommendations.contentClient.getContent(NYTimesRecommendations.getInterests()).then(function recommend(data) {
        worker.port.emit("recommend_on_page", data);
      });
