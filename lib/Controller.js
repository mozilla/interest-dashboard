...
function Controller(options={}) {
  ...
  this._workers = this._workerFactory.getInterestsWorkers();
...
Controller.prototype = {
  ...
  _initStream: function _C__setupStream(storageBackend) {
    ...
    let streamObjects = {
      ...
      timelineDataProcessorBolt: TimelineDataProcessorBolt.create(),
      weightIntensityDataProcessorBolt: WeightIntensityDataProcessorBolt.create(),
      intentInterestDataProcessorBolt: IntentInterestDataProcessorBolt.create(),
    ...
    stream.addNode(streamObjects.timelineDataProcessorBolt);
    stream.addNode(streamObjects.weightIntensityDataProcessorBolt);
    stream.addNode(streamObjects.intentInterestDataProcessorBolt);
