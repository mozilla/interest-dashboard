...
function Controller(options={}) {
  ...
  this._dayBuffer = new DayBuffer(new Pipeline(this._rankers, this._hostStripper,
    this._timelineDataProcessor, this._weightIntensityDataProcessor, this._dispatcher));
