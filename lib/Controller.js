...
const {AreaDataProcessorBolt} = require("streams/areaDataProcessorBolt");
...
Controller.prototype = {
  ...
  _initStream: function _C__setupStream(storageBackend) {
    ...
    let streamObjects = {
      ...
      areaDataProcessorBolt: AreaDataProcessorBolt.create(),
    ...
    stream.addNode(streamObjects.areaDataProcessorBolt);
