...
function Controller() {
  ...
  simplePrefs.on("server_url", this.onPrefChange);
  simplePrefs.on("consented", this.onPrefChange);
  simplePrefs.on("dispatchIdleDelay", this.onPrefChange);
}
...
Controller.prototype = {
  ...
  onPrefChange: function(prefName) {
    switch (prefName) {
      case "server_url":
        this._dispatcher._serverUrl = simplePrefs.prefs.server_url;
        break;
      case "consented":
        this._dispatcher._enabled = simplePrefs.prefs.consented;
        break;
      case "dispatchIdleDelay":
        this._dispatcher._dispatchIdleDelay = simplePrefs.prefs.dispatchIdleDelay;
        break;
    }
  },
