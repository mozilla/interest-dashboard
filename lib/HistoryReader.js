...
function HistoryReader() {
  ...
  // create processors
  this.demogProc = new WorkerProcessor(data.url("loadDemographicProcessor.js"));
  this.addHistoryProcessor(this.demogProc);

  this.categoryProc = new WorkerProcessor(data.url("loadCategoryProcessor.js"));
  this.addHistoryProcessor(this.categoryProc);

  this.ruleProc = new WorkerProcessor(data.url("loadRulesProcessor.js"));
