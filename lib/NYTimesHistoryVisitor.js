...
NYTimesHistoryVisitor = {
  ...
  consumeHistoryVisit: function(visitData, visitMeta) {
    ...
    if (NYTimesHistoryVisitor.storage.nytimesVisits == null) {
      NYTimesHistoryVisitor.storage.nytimesVisits = [];
    }
    ...
    NYTimesHistoryVisitor.storage.nytimesVisits.push(visitObject);
  },

  getVisits: function() {
    return NYTimesHistoryVisitor.storage.nytimesVisits;
  },

  clear: function() {
    NYTimesHistoryVisitor.storage.nytimesVisits = null;
  },
};
