...
exports.pipeline_details = [
	{
		"algorithm_name": "LWCA",
		"algorithm_function": exports.lwca,
		"additional_setup_required": exports.lwca_setup,
	...
	},
	{
		...
		"algorithm_function": exports.lica_maxchunk_dfr_topprob,
	...
	},
	{
		...
		"algorithm_function": exports.lica_maxchunk_dfr_average,
...
exports.lica_maxchunk_setup = function(){
...
//Functionilty that brings everything together
...
exports.test_algorithms = function(){
	...
	for (let algorithm of exports.pipeline_details) {
		if (algorithm.hasOwnPropert("additional_setup_required")) {
			console.log(algorithm.name + " requires some additional setup. Processing now.")
			algorithm.addtional_setup_required()
		}
	}
