...
WorkerFactory.prototype = {
  ...
  _setupEdRulesExtendedWorker: function() {
    let scriptLoader = Cc["@mozilla.org/moz/jssubscript-loader;1"].getService(Ci.mozIJSSubScriptLoader);
    scriptLoader.loadSubScript(data.url("models/edrules_extended/domainRules.js"));
    scriptLoader.loadSubScript(data.url("models/edrules_extended/textModel.js"));
    scriptLoader.loadSubScript(data.url("models/edrules/urlStopwords.js"));
  ...
  getCurrentWorkers: function () {
    return [ this._setupEdRulesWorker(), this._setup58CatWorker(), this._setupEdRulesExtendedWorker()];
  },
