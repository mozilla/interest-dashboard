...
WorkerProcessor.prototype = {
  ...
  consumeHistoryPlace: function(placeData) {
    this.worker.postMessage({"command": "consume_place", "data": placeData});
  },

  consumeHistoryForm: function(formData) {
    this.worker.postMessage({"command": "consume_form", "data": formData});
  },
