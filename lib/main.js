...
exports.main = function(options, callbacks) {
  // Create historyReader if you need to pass specific JSON
  // for one (or more) of the processors create HistoryReader
  // with an argument bellow
  // new HistoryReader({ demographics: json1 , categories: json2, rules: json3});
  // the keys are optional and null values are allowed
