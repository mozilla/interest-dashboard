    ...
    onAttach: function(worker) {
      worker.port.on("donedoc", function() {
        ...
        demographer.onReady(function() {
          ...
          worker.port.emit("show_cats", demographer.getCategories())
          worker.port.emit("show_demog", demographer.getDemographics());
          worker.port.emit("show_rules", demographer.getRules());
        });
      });
    }
  });
