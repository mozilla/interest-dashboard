...
exports.main = function(options, callbacks) {
  ...
  AddonManager.addAddonListener(gController);
  ...
  if (options.loadReason == "install") {
    // process history in the background and load a survey tab on completion
    gController.resubmitFullHistory().then(() => {
      // the history is done - open a survey tab
      tabs.open({
