  ...
  create: function _SDPB_create(storageBackend) {
    let node = createNode({
      ...
      _getRadius: function(isToplevel, parentRadius) {
        ...
        return {"radius": radius, "recommendationCount": recommendationCount};
      },
      ...
      _generateStructForD3: function(categories) {
        ...
        for (let category in categories) {
          ...
          let parentRadiusInfo = this._getRadius(true);
          let topLevelNode = {"id": id,
                              "recommendationCount": parentRadiusInfo.recommendationCount,
                              "radius": parentRadiusInfo.radius,
          ...
          this._categoricalNodes[category][0].fixed = true;
          ...
          for (let subcat in subcatSet) {
            ...
            this._categoricalNodes[category].push({
              "id": subID,
              "radius": this._getRadius(false, parentRadiusInfo.radius),
              "name": subcat
            });
      ...
      ingest: function _HSB_ingest(message) {
        ...
        this.results = this.storage.chartData.spiderData;
      },
